...
class Assign_Tickets extends StatefulWidget {
  ...
  @override
  Assign_TicketsState createState() => Assign_TicketsState();
}

class Assign_TicketsState extends State<Assign_Tickets> {
                                        ...
                                        IconButton(
                                            onPressed: () {
                                              ...
                                              Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                      builder: (builder) =>
                                                          AssignTicketsDetailsView(
                                                            draftno:
                                                            int.parse(list.docNo.toString()),TicketType:TicketType.toString(),list: li3,id:li3.indexOf(list), Branch1:BranchName1
                                                            /*callback:
