...
class SuperAdminAllUtilityitemsTicketReports extends StatefulWidget {
   SuperAdminAllUtilityitemsTicketReports({ Key? key, required  String this.getScreenName,required String this.getTicketType}) : super(key: key);
  ...
  @override
  SuperAdminAllUtilityitemsTicketReportsState createState() => SuperAdminAllUtilityitemsTicketReportsState();
}

class SuperAdminAllUtilityitemsTicketReportsState extends State<SuperAdminAllUtilityitemsTicketReports> {
