...
import 'package:jasper/Admin/ApprovedAssignTickets.dart';
...
class ApprovedAssignTicketsDetailsView extends StatefulWidget {
  final int draftno;
 ...
 final int id;
  ...
  List<FilterList1> list1;


  // Function callback;
  ApprovedAssignTicketsDetailsView({Key? key, required this.draftno ,required this.TicketType,required this.list1,required this.id,required this.Branch1/*, this.callback*/})
      : super(key: key);

  /* final String text;
  PurchaseOrderApprovalItem({Key?key, required this.text}) : super(key: key);*/
  @override
  _ApprovedAssignTicketsDetailsViewState createState() =>
      _ApprovedAssignTicketsDetailsViewState();
}

class _ApprovedAssignTicketsDetailsViewState extends State<ApprovedAssignTicketsDetailsView> {
  ...
  void initState() {
    ...
    Edt_PoNo.text=widget.list1[widget.id].ticketNo.toString();
    Edt_PoDate.text=widget.list1[widget.id].requiredDate.toString();
    Edt_SupplierName.text=widget.list1[widget.id].category.toString();
    Edt_ShipFrom.text=widget.list1[widget.id].issueType.toString();
    ItemCategory.text=widget.list1[widget.id].itemCode.toString();
    ItemName.text=widget.list1[widget.id].itemName.toString();
    BranchName1.text=widget.list1[widget.id].brachName.toString();
    Priority.text=widget.list1[widget.id].priority.toString();
    Remarks.text=widget.list1[widget.id].description.toString();
    EmpName.text=widget.list1[widget.id].empName.toString();
    EmpContactNo.text=widget.list1[widget.id].empContactNo.toString();
    IssueCategory.text=widget.list1[widget.id].issueCatrgory.toString();
    AgeingDays.text=    widget.list1[widget.id].status!=
        "C"
        ? '${DateTime.now().difference(DateFormat("yyyy-MM-dd").parse(widget.list1[widget.id].createdDate.toString())).inDays.toString()}'
        : '${DateFormat("yyyy-MM-dd").parse(widget.list1[widget.id].createdDate.toString()).difference(DateFormat("yyyy-MM-dd").parse(widget.list1[widget.id].createdDate.toString())).inDays.toString()}';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Approved Ticket Details'),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      new Expanded(
                        flex: 3,
                        child:widget.list1[widget.id].empContactNo.toString()!=null
                            &&
                            widget.list1[widget.id].empContactNo.toString().length>9?
                        Center(
                            child: InkWell(
                              // onTap:() async {
                              ...
                              // },
                                child: InkWell(
                                    onTap: () async {
                                      var url = 'tel:${widget.list1[widget.id].empContactNo.toString()}';
                    ...
                    children: [
                      ...
                      new Expanded(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            color: Colors.white,
                            child: widget.list1[widget.id].attachFileName.toString()!=null
                                &&
                                widget.list1[widget.id].attachFileName.toString().isNotEmpty?Column(
                              children: [
                                new TextButton.icon(
                                  onPressed: () {
                                    showDialog(
                                                ...
                                                children: [
                                                  Image
                                                    ...
                                                    AppConstants.LIVE_URL+
                                                        widget.list1[widget.id].attachFileName.toString(),
                                                  ),
                                                  SizedBox(
                                                    height: 10,
                                                  ),
                ...
                onPressed: () {
                  setState(() {
                          ...
                          if(textFieldController.text!="") {
                            updateTicketStatus(7, int.parse(widget.list1[widget.id].docNo
                                .toString()), widget.list1[widget.id].brachName.toString(),
                                textFieldController.text);
                            Navigator.pop(context);
                          }else{
                    ...
                    style: ElevatedButton.styleFrom(textStyle: const TextStyle(fontSize: 20,color:Colors.green),),
                      onPressed: () {
                              setState(() {
                                ...
                                updateTicketStatus(8,int.parse(widget.list1[widget.id].docNo.toString()),widget.list1[widget.id].brachName.toString(),textFieldController.text);
                                Navigator.pop(context);
