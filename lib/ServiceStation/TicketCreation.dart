 ...
 late String SessionEmpID, SessionEmpName, SessionBranchId, SessionBranchName,SessionAdminUser,SessionDepartmentCode,SessionDepartmentName,SessionLocation;
  ...
  void getStringValuesSF() async {
    ...
    setState(() {
      ...
      SessionEmpID = prefs.getString('UserID')!;
      SessionEmpName = prefs.getString('UserName')!;
      SessionBranchId = prefs.getString('BranchID')!;
      SessionBranchName = prefs.getString('BranchName')!;
      SessionAdminUser = prefs.getString('AdminUser')!;
      SessionDepartmentCode = prefs.getString('DepartmentCode')!;
      SessionDepartmentName = prefs.getString('DepartmentName')!;
      SessionLocation = prefs.getString('Location')!;
