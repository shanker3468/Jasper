...
class TicketCreationFinal extends StatefulWidget {
  const TicketCreationFinal({Key? key}) : super(key: key);

  @override
  State<TicketCreationFinal> createState() => TicketCreationFinalState();
}

class TicketCreationFinalState extends State<TicketCreationFinal> {
 ...
 late String SessionEmpID, SessionEmpName, SessionBranchId, SessionBranchName,SessionAdminUser,SessionDepartmentCode,SessionDepartmentName,SessionLocation,EmpGroup;
  ...
  Future<http.Response> insertticket() async {
    ...
    var body = {
      ...
      "ItemName":EmpGroup=="Tools"?ItemName:"",
      "ItemCode":EmpGroup=="Tools"?ItemCode:"",
      "Priority": selectstate,
      "Extra1":EmpGroup=="Tools"?ItemCategory:"",
      "Extra2":EmpGroup=="Tools"?ItemCategoryCode:"",
      "Extra3":""
    };
